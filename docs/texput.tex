...
\begin{figure}
  \centering
  \svgfig{graphics/DWT_scaled}{4cm}{400}
...
\begin{figure}
  \centering
  \begin{tabular}{ccc}
    \vbox{\pngfig{graphics/lena}{5cm}{500}} & \vbox{\pngfig{graphics/dwt_lena}{5cm}{500}} & \vbox{\pngfig{graphics/dwt_lena_normalized}{5cm}{500}}\\
    (a) & (b) & (c)
  \end{tabular}
